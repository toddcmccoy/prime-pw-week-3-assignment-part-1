...
let favFoods = ['burnt ends', 'smoked ribs', 'tacos', 'cheese'];
...
let animal = animalArray[animalArray.length - 1];
console.log (animal);
...
console.log('My Favorite food are now', favFoods);
...
let foodString = favFoods.join(" and ");
...
let animalFood = favFoods.concat(animalArray);
